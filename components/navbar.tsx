...
import { Menu, Lightbulb, Users, Info, Heart } from 'lucide-react'
  ...
  return (
    <div className="fixed top-0 left-0 right-0 z-50 px-4 py-3">
      ...
      <header className="mx-auto max-w-7xl relative">
        <nav className="relative flex items-center justify-between rounded-full border bg-background/95 px-4 sm:px-6 py-2 sm:py-3 shadow-lg backdrop-blur supports-[backdrop-filter]:bg-background/60 hover:bg-muted/50 transition-colors">
              ...
              <SheetContent side="top" className="w-full h-[80vh] pt-16">
                <div className="flex flex-col items-center space-y-4">
                  ...
                  <div className="flex flex-col items-center w-full max-w-xs space-y-3 pt-4">
                    <a href={DONATE_URL} target="_blank" rel="noopener noreferrer" className="w-full">
